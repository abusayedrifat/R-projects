...
pacman::p_load(rlang, tidyverse, knitr, here, outbreaks, gt)
...
family_stats %>% 
  pivot_longer(2:5, 
               names_sep  = "_",
               names_to = c("family_member",".value"))
```
...
# here "\\" used for escaping special character error
```
...
```{r}
data <- tibble::tribble(
  ~patient, ~day1_systolic, ~day1_diastolic, ~day2_systolic, ~day2_diastolic,
  "P1",            120,             80,             122,              82, 
  "P2",            130,             85,             135,              88, 
  "P3",            125,             82,             130,              85 
)
...
disease_stats_long <- 
  tibble::tribble(
    ~country, ~quarter, ~new_cases, ~deaths,
    "A",    "Q1",        180,         20,
    "A",    "Q2",        210,         25,
    "A",    "Q3",        230,         30,
    "B",    "Q1",        150,         15,
...
disease_stats_long |> 
  pivot_wider(names_from = "country",
              values_from = c("new_cases","deaths"))
```
